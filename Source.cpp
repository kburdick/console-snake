/**
* Purpose: To Learn Basic Console Applications and Game Programming Techniques
* Author: Kurt Burdick
*		-- modified from usr: javidx9
* date: 3/10/20
*/
...
int main()
{
	...
	while (1)
	{
		...
		while (!bDead)
		{
			...
			wsprintf(&screen[nScreenWidth + 10], L"HIGH SCORE: %d               --- S N A K E ---               SCORE: %d", nHighScore, nScore);
